...
# ============================================================================
# PHASE 6 — COVARIANCE-IDENTIFIABILITY FITTER
#
# Usage:
#   Rscript phase6_glmer_fit.R input.csv output.json true_effect M1
#   Rscript phase6_glmer_fit.R input.csv output.json true_effect M2
#
# M1:
...
if (length(args) < 4) {
  stop(
    paste(
      "Usage: Rscript phase6_glmer_fit.R",
